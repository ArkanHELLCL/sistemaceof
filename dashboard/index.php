                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <?php if ($_SESSION['per_id'] === 1) { ?>
                                ...
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCarga" aria-expanded="false" aria-controls="collapseCarga">
                                ...
                                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseMaestros" aria-expanded="false" aria-controls="collapseMaestros">
                                    <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                    Empresas
                                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                </a>
                                <div class="collapse" id="collapseMaestros" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Sysinfo 2024</div>                            
                        </div>
                    </div>
                </footer>
            </div>
